...
Authoritative index for `pdf-text-extractor`. Per `AGENTS.md`, **Accepted** ADRs govern system structure; hypothesis or superseded entries are marked in each file.

| ID | Title | Status |
|----|-------|--------|
| [0001](./0001-layered-native-architecture.md) | Layered native application architecture | Accepted |
| [0002](./0002-work-folder-artifact-contract.md) | Work-folder artifact and downstream contract | Accepted |
